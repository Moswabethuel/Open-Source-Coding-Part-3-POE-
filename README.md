...
for rate-limited access (free tier: 10,000 requests/day). Error Handling: Network errors show toast messages; retries via swipe-refresh. Rate Limits: Handled with caching; inform users if limits are hit.
